...
const about = {
  ...
  info: [
    ...
    {
      fieldName: "Email",
      fieldValue: "raghu0894@gmail.com",
    },
    {
      fieldName: "Github",
      fieldValue: "raghu04",
...
const education = {
  ...
  items: [
    ...
    {
      institute: "SVIT Polytechnic",
      degree: "Diploma, Computer Science",
      duration: "2011 - 2014",
    },
    {
      institute: "Nava Jyothi High School",
      degree: "10th / SSLC",
      duration: "2002 - 2011",
    },
  ],
                    ...
                    {experience.items.map(
                      ({ company, duration, position }, index) => (
                        ...
                        >
                          ...
                          <div className="flex xl:items-center items-center gap-3">
                            {/* dot */}
            ...
            <TabsContent value="education" className="w-full">
              <div className="flex flex-col gap-[30px] text-center xl:text-left">
                ...
                <ScrollArea className="h-[400px]">
                  <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
                    {education.items.map(
                      ({ institute, duration, degree }, index) => (
                        <li
                          key={index}
                          className="bg-[#232329] h-[184px] py-6 px-10 rounded-xl flex flex-col justify-center items-center lg:*:items-start gap-1"
                        >
